...
int compareBook(const void* p, const void* q)
{
    return strcmp(((book*)p)->name,((book*)q)->name);
}
...
int main(void)
{
    ...
    qsort(b1,10,sizeof(book),compareBook);

    printf("After ascending order of price after qsort:\n");
    printArray(b1, 10);
